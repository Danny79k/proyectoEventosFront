...
export default function Footer() {
    ...
    return (
        <div className={`py-12 ${(!light) ? "bg-amber-50 claro" : "bg-gray-800 oscuro"}`}>
            ...
            <p className='text-center pt-10 text-gray-400'><strong>Asociaciones ©</strong> 2025 by <strong><a href="https://github.com/Danny79k/proyectoeventosfront" target="_blank">Danny Belloli</a> & <a href="https://github.com/JeffreyArrosio/ProyectoEventosBack" target="_blank">Jeffrey Arrosio</a></strong> is licensed under CC BY-NC-SA 4.0 </p>
