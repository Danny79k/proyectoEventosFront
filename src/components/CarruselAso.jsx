                    ...
                    <SwiperSlide key={aso.id} className="flex justify-center">
                        <div className="max-w-sm rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                            <Link to={`/asociacion/${aso.id}`}>
                                <img className="w-full h-48 object-cover" src={(aso.main_image) ? `https://jeffrey.informaticamajada.es/storage/${aso.main_image}`: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRjk57_dSSq3YibwbmuS_Pb7zArnEfQEJ9cHw&s"} alt={aso.name}
                                />
                                <div className="p-5">
